...
public class ColorRandom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_color_random);
        delayer();
    }
    ...
    private void changeTextColor(int choice) {
        color = findViewById(R.id.colorText);
        switch (choice) {
            case 0 : color.setTextColor(Color.RED);
                break;
            case 1 : color.setTextColor(Color.BLUE);
                break;
            case 2 : color.setTextColor(Color.GREEN);
                break;
            case 3 : color.setTextColor(Color.BLACK);
                break;
            case 4 : color.setTextColor(Color.YELLOW);
                break;
        }
    }
